...
class EditFolderActivity: SingleFragmentActivity() {
    ...
    companion object{
        ...
        fun newIntent(context: Context, folderId: Long): Intent{
            val intent = Intent(context, EditFolderActivity::class.java)
            intent.putExtra(FOLDER_ID, folderId)
            return intent
        }
    }

    override fun createFragment(): Fragment = EditFolderFragment.newInstance(folderId)
